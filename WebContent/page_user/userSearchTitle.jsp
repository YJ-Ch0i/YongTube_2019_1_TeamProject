...
<body class="appear-animate">
    ...
    <section class="small-section bg-gray-lighter">
        <div class="relative container align-left">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">검색 결과</h1>
            ...
            <section class="page-section">
                ...
                <div class="container relative">
                    ...
                    <div class="row multi-columns-row">
                        ...
                        <!-- Post Item -->
                        <%
                         	ArrayList<VideoDTO> videoList = (ArrayList<VideoDTO>)request.getAttribute("v_list");
 ...
 <!-- JS -->
  <!-- JS -->
        ...
        <!-- Replace test API Key "AIzaSyAZs..DkJFLS0b59q7cmW0EprwfcfUA8d9dg" with your own one below 
